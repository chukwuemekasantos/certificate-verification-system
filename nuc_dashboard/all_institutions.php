<?php
    ...
    $SelectInstitutions = $select->SelectInstitutions();
          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">List Of Institutions</h4>
                  
                   <button class="btn btn-success btn-md float-right" onclick="window.location.href='add_institution.php'" style="background-color:darkgreen;">Add Institution</button>
              </div>
              <div class="card-body">
                <div class="toolbar">
                ...
                <?php
                      ...
                      foreach($SelectInstitutions as $value):
                      
                ?>
                    <tr>
                      <td><?=$value['institution_name']?></td>
                      <td><?=$value['institution_email']?></td>
                      <td><?=$value['institution_reg_status']?></td>
                      <td class="text-right">
