...
//                                   echo '
//                                    <h6 class="text-center c"><i class="nc-icon nc-alert-circle-i"></i> Student Registeration Number is Already Added.</h6>
//                                    ';
//                                    break;
//                                case "success":
//                                   echo '
//                                    <h6 class="text-center s"><i class="nc-icon nc-check-2"></i> Successfully Added Student Certificate Information.</h6>
//                                   ';
//                                    break;
//                                case "too_large":
//                                    echo '
//                                     <h6 class="text-center c"><i class="nc-icon nc-alert-circle-i">Sorry, Image Size Is Too Large.</h6>
//                                    ';
//                                    break;
//                                case 'failed_to_upload_file':
//                                    echo '
//                                            
//                                        <h6 class="text-center c"><i class="nc-icon nc-alert-circle-i">Sorry, Failed To Add Student Cerfiticate Information.</h6>
//                                    ';
//                                    break;
//                                default:
//                                    echo "";
                ...
                <div class="card-body " style="margin-top:-40px;">
                      ...
                      <div class="row justify-content-center">
                        ...
                        <div class="col-sm-6">
                          <div class="input-group">
                            ...
                            <input type="text" class="form-control" placeholder="Institution Name" name="name" required>
                          </div>
                          <div class="input-group">
                            <div class="input-group-prepend">
                        ...
                        <div class="col-sm-5">
                         ...
                         <div class="col-sm-5">
                            <label>Country</label>
                            <div class="form-group">
                                 <input class="form-control" name="country" placeholder="country (required)" required>
                            </div>
                        </div>    
                         ...
                         <div class="col-sm-5">
                            <label>Email</label>
                            <div class="form-group">
                                 <input class="form-control" name="email" placeholder="country (required)" required>
                            </div>
                        </div>    
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                            <input class="form-control" name="password" placeholder="state (required)" required>
                            </div>
                        </div>
                         <div class="col-sm-5">
                            <label>Phone</label>
                 ...
                 <div class="card-footer text-center">
                  <div class="pull-right">  
                     <input type="submit" class="btn btn-success" value="Add" name="add_student"/>
                  </div>
