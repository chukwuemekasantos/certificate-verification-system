          ...
          <li class="nav-item active">
             <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                            <a class="dropdown-item" href="login.php">Nuc Login</a>
            ...
            <form class="form" method="post">
              <div class="card card-login">
                <div class="card-header ">
                  <div class="card-header ">
                    <h3 class="header text-center">NUC Login</h3>
                  </div>
                </div>
                <div class="card-body ">
                    <?php

			         if ($check_Admin == "invaliduser"):
		
		              ?>
                    
                        <h6 class="header text-center" style="color:darkred; font-size:13px;"><?="invalid credentails"?></h6>
                ...
                <div class="card-footer" style="padding-top:-10px;">
                    <input type="submit" class="btn btn-warning btn-round btn-block mb-3" name="login" value="Login"/>
                </div>
              </div>
            </form>
          </div>
