...
<!-- Mirrored from demos.creative-tim.com/paper-dashboard-2-pro/examples/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jun 2019 13:54:32 GMT -->
...
<head>
  ...
  <!--     Fonts and icons     -->
 <link href="./nuc_dashboard/assets/css/font-awesome.css" rel="stylesheet" />
  <!-- CSS Files -->
  <link href="./institution_dashboard/assets/css/bootstrap.min.css" rel="stylesheet" />
  <link href="./institution_dashboard/assets/css/paper-dashboard.min790f.css?v=2.0.1" rel="stylesheet" />
  <!-- CSS Just for demo purpose, don't include it in your project -->
  <link href="./institution_dashboard/assets/demo/demo.css" rel="stylesheet" />
  <!-- Extra details for Live View on GitHub Pages -->
  <!-- Google Tag Manager -->
  <script>
    (function(w, d, s, l, i) {
