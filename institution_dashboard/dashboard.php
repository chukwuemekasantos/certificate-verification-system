<?php
    ...
    $countF = $select->countF($institution_id);

    $countD = $select->countD($institution_id);

    $countS =  $select->countS($institution_id);
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php print_r($countF) ?>
                        <p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php print_r($countD) ?>
                        <p>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-7 col-md-8">
                    <div class="numbers">
                      ...
                      <p class="card-title"><?php print_r($countS) ?>
                        <p>
                    </div>
                  </div>
                </div>
...
<!-- Mirrored from demos.creative-tim.com/paper-dashboard-2-pro/examples/dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Jun 2019 13:57:46 GMT -->
</html>