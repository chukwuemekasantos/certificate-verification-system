          ...
          <div class="col-md-12">
            <div class="card ">
              <div class="card-header ">
                <h4 class="card-title">Verification Method</h4>
              </div>
              <div class="card-body ">
                <form method="post">
                      ...
                      <?php
                        ...
                        $verification_method = $insert->add_verification_method($institution_id);
                         ...
                         switch ($verification_method) {
                                ...
                                case "success":
                                   echo '
                                    <h6 class="text-center s">Verification Method is Added Successfully.</h6>
                                   ';
                                    break;
                                case "nope":
                                    echo '
                                     <h6 class="text-center c">Failed To Add Verification Method.</h6>
                                    ';
                                    break;
                  ...
                  ?>
                     ...
                     <div class="form-group">
                       <input type="text" class="form-control" placeholder="Verification Method" name="verification_name">
                    </div>
                   <div class="row">
                      <div class="col-md-6">
                          <input type="submit" class="form-control btn btn-success" style="background-color:darkgreen; color:white;" name="send" value="Send">
                      </div>
                      <div class="col-md-6">
