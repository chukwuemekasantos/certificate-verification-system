            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">List Of Institutions</h4>
                   ...
                   <button class="btn btn-success btn-md float-right" onclick="window.location.href='add_institution.php'" style="background-color:darkgreen;"><i class="fa fa-plus"></i>Add Institution</button>
              </div>
              <div class="card-body">
                <div class="toolbar">
