<?php
     ...
     $ListOfDepartment = $select->ListOfDepartment();
            ...
            <div class="card">
              <div class="card-header">
                <h4 class="card-title">List Of Department</h4>
                   ...
                   <button class="btn btn-success btn-md float-right" onclick="window.location.href='add_department.php'" style="background-color:darkgreen;"><i class="fa fa-plus"></i>Add Department</button>
              </div>
              <div class="card-body">
                <div class="toolbar">
                ...
                <table id="datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                  ...
                  <tbody>
                    <?php
                      ...
                      foreach($ListOfDepartment as $value):
